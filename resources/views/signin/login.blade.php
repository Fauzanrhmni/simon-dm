...
<section
    ...
    <div class="px-5 flex">
        <form
            class="h-[350px] w-full bg-white mt-[-12rem] rounded-3xl shadow-lg flex flex-col justify-center items-center px-5 border border-black"
            method="POST" action="{{ route('login') }}">
            @csrf
            <div class="flex flex-col w-full gap-4">
                <h1 id="roleText" class="font-semibold text-center mb-3">Silahkan Login Sebagai ...</h1>
                <div class="block">
                    <span
